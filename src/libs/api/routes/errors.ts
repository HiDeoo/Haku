...
export const API_ERROR_TODO_NODE_DELETE_ROOT_NODE_CONFLICT = 'A todo node referenced as a root node cannot be deleted.'
export const API_ERROR_TODO_NODE_DELETE_PARENT_NODE_CONFLICT = 'A todo node referenced by its parent cannot be deleted.'
