...
export const API_ERROR_FOLDER_PARENT_DOES_NOT_EXISTS = 'The parent folder specified does not exist.'
export const API_ERROR_FOLDER_PARENT_INVALID_TYPE = 'The parent folder type is invalid.'
export const API_ERROR_FOLDER_ALREADY_EXISTS = 'This folder already exists.'
