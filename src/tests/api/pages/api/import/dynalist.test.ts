...
import { TodoNode, TodoNodeStatus } from '@prisma/client'
import StatusCode from 'status-code-enum'
import slug from 'url-slug'

import { HttpMethod } from 'constants/http'
import { API_ERROR_IMPORT_DYNALIST_INVALID_OPML, type ApiErrorResponse } from 'libs/api/routes/errors'
import { type TodoMetadata } from 'libs/db/todo'
import { type TodoNodeData } from 'libs/db/todoNodes'
import dynalistHandler from 'pages/api/import/dynalist'
...
describe('dynalist import', () => {
  describe('POST', () => {
    test('should not import from an invalid OPML', () =>
      testApiRoute(dynalistHandler, async ({ fetch }) => {
        ...
        expect(json.error).toBe(API_ERROR_IMPORT_DYNALIST_INVALID_OPML)
      }))
